...
# ************* REQUEST VALUES to interact with EC2 service with action Describe VPC *************
method = 'GET'
service = 'ec2'

# If working with us-east-1, no need to specify region
...
request_parameters = 'Action=DescribeVpcs&Version=2013-10-15'
